...
class CODEBRIM:
    ...
    def __init__(self, is_gpu, args):
        ...
        self.dataset_xml_list = [os.path.join(args.dataset_path, 'defects.xml')]
        self.train_set = self.get_dataset(args.patch_size)
        self.train_loader = self.get_dataset_loader(args.batch_size, args.workers,
                                                                                       is_gpu)
    ...
    def get_dataset(self, patch_size):
        ...
        """
        train_set = CODEBRIMSplit(self.dataset_path,
